...
# Flock calculation
    def find_near_boids(self, boids):
        ...
        self.near_boids = []
        filtered_boids = (boid for boid in boids if boid != self and ((self.position[0] - self.near_distance < boid.position[0] and self.position[1] - self.near_distance < boid.position[1]) and (self.position[0] + self.near_distance > boid.position[0] and self.position[1] + self.near_distance > boid.position[1])))
