...
positive_standard_deviance = [math.sqrt(variance) for variance in variance_times]
...
plt.title(f"Execution time of {type_of_algorithm} with N={N} and repeats={repeats}")
plt.show()